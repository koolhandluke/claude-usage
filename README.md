...
**Based on:** [claude-usage](https://github.com/koolhandluke/claude-usage) by Pawel Huryn ([The Product Compass Newsletter](https://www.productcompass.pm))
...
### Windows
```
git clone https://github.com/koolhandluke/claude-usage
cd claude-usage
